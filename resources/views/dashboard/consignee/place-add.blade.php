...
@section('sidebar-content')
    <div class="dashboard-block mt-0">
        <h3 class="block-title">Add Place</h3>
                ...
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <button class="nav-link active" id="nav-item-info-tab" data-bs-toggle="tab"
                            ...
                            Step
                            <span class="sub-title">Place Information</span>
                        </button>
                        <button class="nav-link" id="nav-item-details-tab" data-bs-toggle="tab"
                            ...
                            Step
                            <span class="sub-title">Place Details</span>
                        </button>
...
@section('custom-js')
    <script>
        ...
        function previewImages() {
            ...
            var images = document.querySelector('#upload').files;
